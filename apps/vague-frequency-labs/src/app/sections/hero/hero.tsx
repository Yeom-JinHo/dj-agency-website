  ...
  return (
    <section className="relative h-[100svh] overflow-x-hidden pt-16">
      <div className="flex h-full flex-col items-center justify-center gap-2 pb-4 sm:gap-4 md:gap-6">
        <p className="font-display w-full text-center text-3xl font-bold sm:text-4xl md:text-5xl lg:text-6xl 2xl:text-7xl">
          We are
        </p>
        ...
        <h1 className="w-full text-center text-2xl font-bold sm:text-3xl md:text-4xl lg:text-5xl 2xl:text-6xl">
