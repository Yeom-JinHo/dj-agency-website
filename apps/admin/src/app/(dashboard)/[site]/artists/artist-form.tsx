      ...
      >
        ...
        <Card className="gap-4 py-4">
          <CardHeader className="border-b">
            <h2 className="text-muted-foreground text-lg font-semibold">기본 정보</h2>
          </CardHeader>
        ...
        <Card className="gap-4 py-4">
          <CardHeader className="border-b">
            <h2 className="text-muted-foreground text-lg font-semibold">설명</h2>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="grid gap-4 sm:grid-cols-2">
              {(
        ...
        <Card className="gap-4 py-4">
          <CardHeader className="border-b">
            <h2 className="text-muted-foreground text-lg font-semibold">대표 작업</h2>
            <CardAction>
              <Button
                type="button"
                variant="outline"
        ...
        <Card className="gap-4 py-4">
          <CardHeader className="border-b">
            <h2 className="text-muted-foreground text-lg font-semibold">이미지</h2>
          </CardHeader>
          <CardContent className="space-y-4">
            <ImageField
              label="프로필 이미지"
